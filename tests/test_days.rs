...
fn test_day11() -> Result<()> {
    assert_eq!(
        run_day(11, advent_of_code_2020::day11::main).unwrap(),
        (2346, Some(2111))
    );
    Ok(())
}
...
fn test_day13() -> Result<()> {
    assert_eq!(
        run_day(13, advent_of_code_2020::day13::main).unwrap(),
...
fn test_day14() -> Result<()> {
    assert_eq!(
        run_day(14, advent_of_code_2020::day14::main).unwrap(),
...
fn test_day15() -> Result<()> {
    assert_eq!(
        run_day(15, advent_of_code_2020::day15::main).unwrap(),
        (234, Some(8984))
    );
    Ok(())
}
...
fn test_day16() -> Result<()> {
    assert_eq!(
        run_day(16, advent_of_code_2020::day16::main).unwrap(),
...
fn test_day17() -> Result<()> {
    assert_eq!(
        run_day(17, advent_of_code_2020::day17::main).unwrap(),
        (391, Some(2264))
    );
    Ok(())
}
